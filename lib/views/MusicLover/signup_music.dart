...
class SignUpMusic extends StatefulWidget {
  const SignUpMusic({Key? key}) : super(key: key);

  @override
  _SignUpMusicState createState() => _SignUpMusicState();
}

class _SignUpMusicState extends State<SignUpMusic> {
                  ...
                  child: GestureDetector(
                    onTap: () {
                      if (email.text.isEmpty &&
                        ...
                        showToast(message: "Please fill up the username and email");
                      } else if (username.text.isEmpty ||
                          RegExp(r"\s").hasMatch(username.text)) {
                        showToast(message: "Please fill up the username with no space");
                        userNameFocusNode.requestFocus();
                      } else if (mobile.text.isEmpty ||
                          RegExp(r"\s").hasMatch(mobile.text)) {
                        showToast(message: "Please fill up the mobile number");
