      ...
      builder: (context, snapshot) {
        ...
        return Scaffold(
          body: Consumer<MyStatsRepo>(
            builder: (context, myDetailsRepo, _) {
              return ShowStats(
                notification: myDetailsRepo.numberOfNotification == null
                    ? 0
                    : myDetailsRepo.numberOfNotification!,
                myStats: myDetailsRepo,
              );
            },
          ),
        );
                        ...
                        child: Column(
                          ...
                          children: [
                            Row(
                              ...
                              children: [
                                StatsCard(
                                    count: myStats.myStats!.noPlacesVisited!,
                                    title: "Places Visited",
                                    imagePath: 'assets/images/location_y.png'),
                                StatsCard(
                                    count: myStats.myStats!.noRequested!,
                                    title: "Requests",
                            ...
                            Row(
                              ...
                              children: [
                                StatsCard(
                                    count: myStats.myStats!.noAccepted!,
                                    title: "Songs accepted",
                                    imagePath: 'assets/images/audio_y.png'),
                                StatsCard(
                                    count: myStats.myStats!.noRejected!,
                                    title: "Rejected",
...
class StatsCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: InkWell(
        onTap: () {
          if (title == "Places Visited") {
            Navigator.push(
              context,
              MaterialPageRoute(builder: (context) => const PlaceVisited()),
            );
          }
          if (title == "Requests") {
            Navigator.pushNamed(
                ...
                '/RequestedSongsMusicLover');
          }
          if (title == "Songs accepted") {
            Navigator.pushNamed(
                context,
